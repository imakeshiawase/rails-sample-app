...
ActiveRecord::Schema.define(version: 2019_03_03_080647) do
  ...
  create_table "claps", options: "ENGINE=InnoDB DEFAULT CHARSET=utf8", force: :cascade do |t|
    ...
    t.index ["track_id"], name: "index_claps_on_track_id"
    t.index ["user_id"], name: "index_claps_on_user_id"
  end

  create_table "track_images", options: "ENGINE=InnoDB DEFAULT CHARSET=utf8", force: :cascade do |t|
    t.bigint "track_id"
    t.string "alt_text", default: "", null: false
    t.datetime "created_at", null: false
    t.datetime "updated_at", null: false
    t.index ["track_id"], name: "index_track_images_on_track_id"
  end
